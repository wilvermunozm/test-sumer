...
class GetGifsUseCase implements UseCase<List<GifModel>, NoParams> {
  final GifRepository _gifRepository;

  GetGifsUseCase({GifRepository? gifRepository}) : _gifRepository = gifRepository ?? sl();

  @override
  Future<Either<Failure, List<GifModel>>> call(NoParams params) async {
    return await _gifRepository.getGifs();
  }
}
